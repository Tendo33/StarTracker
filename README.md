...
-   [emcie-co/parlant](https://github.com/emcie-co/parlant) - Build reliable LLM-based customer facing agents using behavioral guidelines and runtime supervision
